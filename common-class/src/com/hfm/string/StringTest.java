...
public class StringTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // 将字符串中的指定字符进行替换
        System.out.println("StringStr".replace('S', 's'));
        // 将这个字符串的每个子字符串替换为指定的文字替换序列，以匹配文本目标序列。
        System.out.println("StringStr".replace("Str", "s"));
        // 将这个字符串的每个子字符串替换为给定的正则表达式和给定的替换。
        System.out.println("StringStr".replaceAll("Str", "si"));
        // 将这个字符串的第一个子字符串替换为给定的正则表达式和给定的替换。
        System.out.println("StringStr".replaceFirst("Str", "1"));
