...
//        yieldTest3();
    ...
    private static void yieldTest1() {
        EvenNumber2 thread1 = new EvenNumber2("优先级1");
        // 设置优先级为1
        thread1.setPriority(1);
        // 默认优先级为5
        OddNumber2 thread2 = new OddNumber2("优先级5-1");
    ...
    private static void yieldTest2() {
        EvenNumber2 thread1 = new EvenNumber2("优先级5-2");
        // 设置优先级为5
    ...
    private static void yieldTest3() {
        EvenNumber2 thread1 = new EvenNumber2("优先级10");
        // 设置优先级为10
