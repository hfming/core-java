...
public class While {
    public static void main(String[] args) {
        ...
        // 注意：要精确控制循环的次数。常犯错误是是循环多执行一次或者少执行一次。例如会执行 101 次，想要执行 100 次，要么是 count 初始值为 1，然后 count<=100 要么是 count 初始值为 0，coung<100
        // 猜数字游戏:编写程序随即生成一个 0-100 之间的随机数。程序提示用户输入一个数字，不停猜测，直到猜对为止。最后输出猜测的数字，和猜测的次数。并且如果没有猜中要提示用户输入的值是大了还是小了。
        // 思考：如何生成 1-100 之间随机数？
        // 首先程序生成了一个随机数
