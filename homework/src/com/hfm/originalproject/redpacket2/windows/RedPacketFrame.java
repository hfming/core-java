package com.hfm.originalproject.redpacket2.windows;
...
/**
 * @author hfm
 * @version 1.01 2020-04-02 17:21
 * @date 2020/4/2
 */
public class RedPacketFrame extends JFrame {
    private static final long serialVersionUID = 1L;

    private static final String DIR = "project\\pic";
    ...
    // 不可见
    private static JLabel input_inMoney = new JLabel();
