...
public class FileTest {
    public static void main(String[] args) throws IOException {
        ...
        File file = new File("file-io\\Resources\\test.txt");
        // 获取文件名
        System.out.println(file.getName());

        // 通过子父路径创建file 类对象
        String parent = "file-io\\resources";
        ...
        // 通过父目录创建file 对象
        File parentDir = new File("file-io\\resources");
         ...
         */
        System.out.println("重命名文件名：" + file.renameTo(new File("file-io\\Resources\\Test.txt")));
        System.out.println("================================");
